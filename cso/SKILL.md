...
> **STOP.** 在 running the scope-dependent audit phases (Phases 2-11) selected by the resolved mode, after the Phase 0 stack detection and Phase 1 attack-surface census 之前，Read `~/.claude/skills/gstack/cso/sections/audit-phases.md` 并完整执行它。
